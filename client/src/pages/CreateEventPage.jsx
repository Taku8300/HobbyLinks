...
function CreateEventPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const submit = await http.post("http://localhost:8000/api/events", formData);
  ...
  return (
    <div className='py-6 px-6 lg:px-8 text-left md:w-[600px] w-[90%] mx-auto flex flex-col'>
      ...
      <form className='spacy-y-6' onSubmit={handleSubmit}>
        <div>
          <label htmlFor='event_name' className='block mb-2 text-sm font-medium text-grey-900'>
            Event Name
          </label>
        ...
        <div>
          <label htmlFor='type' className='block mb-2 text-sm font-medium text-grey-900'>
            Type
          </label>
          <div className='flex items-center border-2 py-2 px-3 rounded-2xl mb-4'>
            <svg
        ...
        <div>
          <label htmlFor='start_date' className='block mb-2 text-sm font-medium text-grey-900'>
            Start Date
          </label>
          <div className='flex items-center border-2 py-2 px-3 rounded-2xl mb-4'>
            <svg
        ...
        <div>
          <label htmlFor='prefecture' className='block mb-2 text-sm font-medium text-grey-900'>
            Prefecture
          </label>
          <div className='flex items-center border-2 py-2 px-3 rounded-2xl mb-4'>
            <svg
        ...
        <div>
          <label htmlFor='address' className='block mb-2 text-sm font-medium text-grey-900'>
            Address
          </label>
          <div className='flex items-center border-2 py-2 px-3 rounded-2xl mb-4'>
            <svg
