...
function Header() {
  ...
  console.log(name, birthday, gender, registerMail, image, regisPassword);
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      formData.append("registerMail", registerMail);
      formData.append("image", image);

      const register = await axios.post("/api/users", formData);
